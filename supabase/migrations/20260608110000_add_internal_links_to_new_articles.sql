-- Add internal links to the two newest articles for stronger on-site SEO.
...
<p><a href="/products#biobiz">BioBiz</a> is JOAT Kenya's digital business card product. It combines a shareable profile with QR sharing, analytics, AI meeting notes and live translation features. The goal is simple: help professionals turn introductions into follow-ups.</p>
...
<p>To explore BioBiz for yourself or your team, visit the <a href="/products#biobiz">BioBiz product section</a>, review more <a href="/articles">JOAT Kenya articles</a>, or <a href="/contact">contact our team</a> for a walkthrough.</p>
  $body$,
  updated_at = now()
...
<p>JOAT Kenya builds <a href="/products#games">Roblox game development</a> experiences as part of a wider creative technology pipeline. That means 3D art, scripting, education design, brand storytelling and live operations sit together. The goal is not just to publish a map. The goal is to create an experience that people return to.</p>
...
<p>If your organization is exploring a learning game, branded world or Roblox experience, start with the objective. What should the player understand, feel or do after five minutes? Once that is clear, the world can be designed around it. You can also explore JOAT's <a href="/products#blender">Blender animation pipeline</a>, our <a href="/services">services</a>, or <a href="/contact">contact JOAT Kenya</a> to discuss a build.</p>
  $body$,
  updated_at = now()
...
<p data-internal-links="joat-related"><strong>Related JOAT resources:</strong> Explore our <a href="/services">services</a>, see our <a href="/products">products and digital solutions</a>, read more <a href="/articles">articles</a>, or <a href="/contact">contact JOAT Kenya</a> to discuss your project.</p>
  $links$,
  updated_at = now()
where status = 'published'
  and content not like '%data-internal-links="joat-related"%';
